...
export function listGoodsInfo(query:object) {
  return request({
    url: '/api/v1/demo/goodsInfo/list',
    method: 'get',
    params: query
  })
}
...
export function updateGoodsInfo(data:object) {
  return request({
    url: '/api/v1/demo/goodsInfo/edit',
    method: 'put',
    data: data
  })
}
...
export function delGoodsInfo(ids:number[]) {
  return request({
    url: '/api/v1/demo/goodsInfo/delete',
    method: 'delete',
    data:{
      ids:ids
    }
...
export function linkedDataSearch(){
  return request({
    url: '/api/v1/demo/goodsInfo/linkedData',
    method: 'get'
  })
}
