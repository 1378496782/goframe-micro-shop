...
func (c *refundInfoClient) RefundNotify(ctx context.Context, in *RefundNotifyReq, opts ...grpc.CallOption) (*RefundNotifyRes, error) {
	...
	err := c.cc.Invoke(ctx, RefundInfo_RefundNotify_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedRefundInfoServer) RefundNotify(context.Context, *RefundNotifyReq) (*RefundNotifyRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RefundNotify not implemented")
}
...
func RegisterRefundInfoServer(s grpc.ServiceRegistrar, srv RefundInfoServer) {
	// If the following call panics, it indicates UnimplementedRefundInfoServer was
