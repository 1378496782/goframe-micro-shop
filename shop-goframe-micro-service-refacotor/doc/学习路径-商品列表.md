...
> 归档说明：这个文件是早期综合学习笔记，包含商品、Redis、购物车、订单、互动模块、命令和 Git 记录等内容。后续新增学习路线和模块笔记优先写到 `doc/学习路径/` 目录。
>
> 新入口：
>
> - `doc/学习路径/README.md`
> - `doc/学习路径/00-学习总路线.md`
> - `doc/学习路径/04-订单模块.md`
> - `doc/学习路径/08-互动模块.md`
...
- `shop-goframe-micro-service-refacotor/app/goods/utility/consumer/order_return_stock_consumer.go`

其中 `order_return_stock_consumer.go` 是顺手修复的已有日志格式问题，不属于商品搜索主链路。
...
```bash
git add app/gateway-h5/api/goods/v1/goods_info.go app/goods/api/goods_info/v1/goods_info.pb.go app/goods/api/goods_info/v1/goods_info_grpc.pb.go app/goods/internal/controller/goods_info/goods_info.go app/goods/manifest/protobuf/goods_info/v1/goods_info.proto app/goods/utility/consumer/order_return_stock_consumer.go
