...
type GoodsInfoInfoRes struct {
	...
	Images                 string                       `orm:"images" json:"images" dc:"支持单图,多图"`                    // 支持单图,多图
...
type GoodsInfoSearchReq struct {
	...
	Images           string `p:"images" dc:"支持单图,多图"`                                              //支持单图,多图
...
type GoodsInfoAddReq struct {
	...
	Images           []*comModel.UpFile `p:"images" v:"required#支持单图,多图不能为空" dc:"支持单图,多图"`
