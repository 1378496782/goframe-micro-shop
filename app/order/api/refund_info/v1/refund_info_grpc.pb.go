...
const (
	...
	RefundInfo_Refund_FullMethodName    = "/refund_info.v1.refund_info/Refund"
)
...
type RefundInfoClient interface {
	...
	Refund(ctx context.Context, in *RefundNotifyReq, opts ...grpc.CallOption) (*RefundNotifyRes, error)
}
...
func (c *refundInfoClient) GetList(ctx context.Context, in *RefundInfoGetListReq, opts ...grpc.CallOption) (*RefundInfoGetListRes, error) {
	...
	err := c.cc.Invoke(ctx, RefundInfo_GetList_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *refundInfoClient) GetDetail(ctx context.Context, in *RefundInfoGetDetailReq, opts ...grpc.CallOption) (*RefundInfoGetDetailRes, error) {
	...
	err := c.cc.Invoke(ctx, RefundInfo_GetDetail_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *refundInfoClient) Create(ctx context.Context, in *RefundInfoCreateReq, opts ...grpc.CallOption) (*RefundInfoCreateRes, error) {
	...
	err := c.cc.Invoke(ctx, RefundInfo_Create_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *refundInfoClient) Refund(ctx context.Context, in *RefundNotifyReq, opts ...grpc.CallOption) (*RefundNotifyRes, error) {
	out := new(RefundNotifyRes)
	err := c.cc.Invoke(ctx, RefundInfo_Refund_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type RefundInfoServer interface {
	...
	Refund(context.Context, *RefundNotifyReq) (*RefundNotifyRes, error)
...
func (UnimplementedRefundInfoServer) Refund(context.Context, *RefundNotifyReq) (*RefundNotifyRes, error) {
...
func _RefundInfo_Refund_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RefundNotifyReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RefundInfoServer).Refund(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: RefundInfo_Refund_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RefundInfoServer).Refund(ctx, req.(*RefundNotifyReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var RefundInfo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Refund",
			Handler:    _RefundInfo_Refund_Handler,
		},
	},
