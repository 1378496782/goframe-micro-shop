...
func (c *goodsInfoClient) GetGoodsStock(ctx context.Context, in *GetGoodsStockReq, opts ...grpc.CallOption) (*GetGoodsStockRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetGoodsStockRes)
	err := c.cc.Invoke(ctx, GoodsInfo_GetGoodsStock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *goodsInfoClient) DeductStock(ctx context.Context, in *DeductStockReq, opts ...grpc.CallOption) (*DeductStockRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(DeductStockRes)
	err := c.cc.Invoke(ctx, GoodsInfo_DeductStock_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type GoodsInfoServer interface {
	...
	// 获取商品库存
	GetGoodsStock(context.Context, *GetGoodsStockReq) (*GetGoodsStockRes, error)
...
func (UnimplementedGoodsInfoServer) GetGoodsStock(context.Context, *GetGoodsStockReq) (*GetGoodsStockRes, error) {
	return nil, status.Error(codes.Unimplemented, "method GetGoodsStock not implemented")
}
...
func RegisterGoodsInfoServer(s grpc.ServiceRegistrar, srv GoodsInfoServer) {
	// If the following call panics, it indicates UnimplementedGoodsInfoServer was
...
func _GoodsInfo_GetGoodsStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetGoodsStockReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsInfoServer).GetGoodsStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GoodsInfo_GetGoodsStock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsInfoServer).GetGoodsStock(ctx, req.(*GetGoodsStockReq))
	}
	return interceptor(ctx, in, info, handler)
}

func _GoodsInfo_DeductStock_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeductStockReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(GoodsInfoServer).DeductStock(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: GoodsInfo_DeductStock_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(GoodsInfoServer).DeductStock(ctx, req.(*DeductStockReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var GoodsInfo_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _GoodsInfo_GetGoodsStock_Handler,
		},
		{
